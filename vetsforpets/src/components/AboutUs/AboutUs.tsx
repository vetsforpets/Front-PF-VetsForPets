  ...
  const teamMembers = [
    {
      ...
      socials: [
        {
          name: "LinkedIn",
          url: "https://www.linkedin.com/in/elias-nahuel-adad",
          icon: "icons/linkedin.png",
        },
        {
          name: "GitHub",
          url: "https://github.com/EliasAdad",
    ...
    },
    {
      ...
      socials: [
        ...
        {
          name: "GitHub",
          url: "https://github.com/CristianCamelo",
          icon: "icons/github.png",
        },
      ],
    },
    ...
    },
    {
      ...
      socials: [
        {
          name: "LinkedIn",
          url: "https://www.linkedin.com/in/carlos-eduardo-figueira-214a64275/?locale=es_ES",
          icon: "icons/linkedin.png",
        },
        {
          name: "GitHub",
          url: "https://github.com/Carlosf12",
          icon: "/icons/github.png",
        },
      ],
    },
    {
      ...
      socials: [
        {
          name: "LinkedIn",
          url: "https://www.linkedin.com/in/maría-paz-rivas-3aabb32bb",
          icon: "icons/linkedin.png",
        },
        {
          name: "GitHub",
          url: "https://github.com/Maria-Paz-Rivas",
          icon: "/icons/github.png",
        },
      ],
    },

    {
      ...
      socials: [
        {
          name: "LinkedIn",
          url: "https://www.linkedin.com/in/sebastian-sanjorge-frontend-developer",
          icon: "icons/linkedin.png",
        },
        {
          name: "GitHub",
          url: "https://github.com/tiansanjorge",
          icon: "/icons/github.png",
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen p-6 flex flex-col items-center justify-center w-[90%] mx-auto">
      ...
      <div className="flex flex-col w-full mb-12 md:flex-row">
        ...
        <div className="flex items-center justify-center md:w-1/2">
          <p
            ...
            data-aos="fade-left"
          >
            Somos una comunidad comprometida con el bienestar y la salud
            integral de tu mascota. Nuestro propósito es actuar como un puente
            confiable entre los dueños de mascotas y los profesionales de la
            salud veterinaria, facilitando el acceso a servicios de calidad de
      ...
      <div className="flex flex-col w-full mb-8 ml-auto md:flex-row">
        <div className="flex items-center justify-center md:w-1/2">
          <p
            ...
            data-aos="fade-right"
          >
            Creemos que cada mascota merece recibir la mejor atención posible,
            por eso conectamos a los dueños con veterinarios calificados,
            brindando la posibilidad de agendar turnos, consultar resultados
            clínicos y obtener asesoramiento especializado en cualquier momento.
          </p>
        </div>
      ...
      <div className="flex flex-col w-full md:flex-row">
        ...
        <div className="flex items-center justify-center md:w-1/2">
          <p
            ...
            data-aos="fade-up"
          >
            Además, fomentamos una red de apoyo donde los profesionales pueden
            gestionar de forma eficiente sus consultas y mantenerse en contacto
            directo con sus pacientes.
          </p>
        </div>
      </div>
      ...
      <p
        ...
        data-aos="fade-left"
      >
        Juntos construimos un espacio donde la salud, el cuidado y el amor por
        los animales son nuestra prioridad.
      </p>
      ...
      <div className="grid w-full max-w-6xl grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            />
            <h3 className="mt-4 text-xl font-semibold text-customBrown">
              {member.name}
            </h3>
