//CODIGO COMENTADO PARA LOS BOTONES DE MEDICALRECORDS//
// "use client";
...
//       <label
//         htmlFor="file-input"
//         className="inline-flex items-center justify-center w-full max-w-full px-4 py-2 mx-auto my-3 text-sm text-center transition-all rounded-md shadow-md cursor-pointer xs:text-xs sm:text-sm md:text-base lg:text-lg customButton hover: bg-customBrown"
//       >
//         Seleccionar archivo
//       </label>
//       <input
