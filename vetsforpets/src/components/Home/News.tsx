...
const MostrarNoticia = () => {
    const noticias: Noticia[] = [
        ...
        },
        {
            ...
            descripcion: "Las visitas regulares al veterinario son esenciales para detectar...",
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center p-12">
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 w-full max-w-[1000px]">
                    {noticias.slice(0, 2).map((noticia) => (
                        <div
                            key={noticia.id}
                            className="w-full sm:w-[400px] md:w-[500px] text-center flex flex-col items-center  shadow-2xl"
                            data-aos="fade-right"
                        >
            ...
            <div className="flex items-center justify-center space-x-4">
                <div
                    className="w-[1000px] text-center  flex flex-col items-center shadow-lg"
                    data-aos="fade-up"
                >
                    <div className="relative w-full h-96">
                        <Image
                            src={noticias[2].imagenUrl}
                    ...
                    <div className="flex flex-col flex-grow w-full p-4 rounded-b-2xl bg-customLightBrown">
                        <p className="flex-grow text-gray-700">{noticias[2].descripcion}</p>
                        <div className="flex justify-end mt-4">
                            <button
                                onClick={() => openModal(noticias[2])}
                                className="px-4 py-2 rounded-md customButton"
                            >
                                Leer más
                            </button>
            ...
            {modalContent && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="w-3/4 max-w-4xl p-8 bg-white rounded-xl">
