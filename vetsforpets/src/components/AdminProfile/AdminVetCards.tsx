...
const PetShopsList = () => {
    ...
    return (
        <div className="container p-4 mx-auto">
            <h1 className="text-2xl font-bold text-center">Veterinarias</h1>
            ...
            <div className="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2 lg:grid-cols-3">
                {petShops.length > 0 ? (
                    petShops.map((petShop) => (
                        <div
                            key={petShop.id}
                            className="p-4 transition duration-200 border rounded-lg shadow-md hover:shadow-lg bg-[#f1bd81]"
                        >
                ...
                >
                    <div className="p-6 bg-white rounded-lg w-96">
                        ...
                        <div className="p-4">
                            ...
                            />
                            <p className="mb-2"><strong>Fundada:</strong> {selectedPetShop.foundation}</p>
                            <p className="mb-2"><strong>Veterinario a Cargo:</strong> {selectedPetShop.veterinarian}</p>
                            <p className="mb-2"><strong>Número de Matrícula:</strong> {selectedPetShop.licenseNumber}</p>
                            <p className="mb-2"><strong>Número de Teléfono:</strong> {selectedPetShop.phoneNumber}</p>
                            <p className="mb-2"><strong>Email:</strong> {selectedPetShop.email}</p>
                        </div>
