...
const CalendlySearch = () => {
  ...
  useEffect(() => {
    const data: Veterinaria[] = [
      ...
      },
      {
        ...
        url: "https://calendly.com/veterinariacrena8?primary_color=DDA15E",
      },
      {
        id: 4,
        nombre: "Veterinaria Copello",
        url: "https://calendly.com/veterinariacopello2?primary_color=DDA15E",
      },
      {
        id: 5,
        nombre: "Veterinaria Animal House",
        url: "https://calendly.com/veterinariaanimalhousemdq?primary_color=DDA15E",
      },
      {
        id: 6,
        nombre: "Veterinaria Antartida Argentina",
        url: "https://calendly.com/veterinariaantartidaargentina?primary_color=DDA15E",
      },
      {
        id: 7,
      ...
      },
      {
        ...
        url: "https://calendly.com/veterinarialoscorrales9?primary_color=DDA15E",
      },
      {
        id: 10,
        nombre: "Veterinaria La Rinconada",
        url: "https://calendly.com/veterinarialarinconada28?primary_color=DDA15E",
      },
    ];
  ...
  return (
    <div className="p-4 App">
      <h2 className="m-5 text-2xl text-center text-customDarkGreen">
        Elegí tu veterinaria de confianza y reservá un turno de manera rápida y
        sencilla
      </h2>
