      ...
      <div className="relative w-full flex justify-center items-start pt-[139px]"> 
        ...
        <div className="w-full flex flex-col md:flex-row justify-evenly items-center md:items-start md:gap-8 bg-customLightBrown">
            ...
            <div className="flex-auto text-center flex flex-col items-center mt-20 mb-14"> 
              <h2 className="text-black text-lg font-tenor mb-4">Vets For Pets</h2>
              <p className="font-kiwi text-center">
              Cuidamos la salud y el bienestar de tus mascotas. <br></br> Con un equipo profesional listo para brindar la mejor atención.</p>

            </div>

            {/* Enlaces Rápidos */}
            <div className="flex-auto text-center flex flex-col items-center mt-10"> 
              <h2 className="text-black text-lg font-tenor mb-4">Enlaces Rápidos</h2>
              <ul className="font-kiwi space-y-2">

                <li>
                  <Link href="#" className="hover:text-customDarkGreen transition-colors duration-300">
                    Inicio
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="hover:text-customGreen transition-colors duration-300">
                    Botón de emergencia
                  </Link>
                </li>
                <li>
                  <Link href="#" className="hover:text-customBrown transition-colors duration-300">
                    Sobre nosotros
                  </Link>
                </li>
                <li>
                  <Link href="#" className="hover:text-customBeige transition-colors duration-300">
                    Veterinarias
                  </Link>
                </li>
